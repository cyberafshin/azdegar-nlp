...
/**
 * An experimental class that provides static methods for testing and computing
 * various properties of strings that are presumed to be English nouns.
 *
...
public class EnglishNoun {
    ...
    public static boolean isPlural(String word) {
        ...
        if (word.length() <= 2 || word.matches("has|was|his|its|mrs|lts|cosmos")) { //Afshin
            return false;
        }
        ...
        if (word.endsWith("ous") || word.endsWith("sis") || word.endsWith("ics")) {
            return false;
        }
    ...
    /**
     * Returns the plural of a given (presumed) English word. The given word may
     * be singular or (already) plural.
     */
    ...
    /**
     * Returns the singular of a given (presumed) English word. The given word
     * may be plural or (already) singular.
     */
    public static String singularOf(String word) {
        ...
        {
            if (word.toLowerCase().matches("movies")) {
                return "movie";
            } else {
    ...
    private final static HashMap irregularSingulars = new HashMap(100);
    private final static HashMap irregularPlurals = new HashMap(100);
    ...
    static {
        ...
        irregularSingulars.put("data", "data");
        ...
        index.add("indices");
        index.add("indexes");
        irregularSingulars.put("index", index); //Afshin
        ...
        irregularSingulars.put("os", "oses");
        ...
        irregularSingulars.put("‫‪species", "‫‪species");
        ...
        irregularPlurals.put("‫‪species", "‫‪species");
        irregularPlurals.put("squid", "squid");
        irregularPlurals.put("tableaux", "tableau");
